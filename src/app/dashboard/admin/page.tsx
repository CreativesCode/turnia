...
export default function AdminPage() {
  return (
    <div className="space-y-4">
      ...
      {/* Menú (inspirado en "Dashboard Admin - Mobile") */}
...
function Icon({ name }: { name: 'user-plus' | 'users' | 'calendar-clock' | 'download' | 'file-text' | 'building' }) {
  // Íconos minimalistas (lucide-like) para no agregar dependencias.
  switch (name) {
    case 'user-plus':
      return (
